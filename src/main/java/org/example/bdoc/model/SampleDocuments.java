...
public final class SampleDocuments {
    ...
    public static DocumentModel sample() {
        ...
        page.addObject(new VectorShape("shape-1", "layer-decor", ShapeType.ROUNDED_RECTANGLE, 40, 40, 515, 762, 24, 24));
        page.addObject(new VectorShape("shape-2", "layer-decor", ShapeType.LINE, 70, 120, 455, 0, 0, 0));
        page.addObject(new TextFrame("text-1", "layer-text", "story-1", 70, 150, 455, 180));
